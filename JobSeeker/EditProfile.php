...
<form method="post" action="updateProfile.php">
                <table width="100%" border="1" cellspacing="2" cellpadding="2">
                  <tr>
                    <td><strong>JobSeek ID:</strong></td>
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtqualification" type="text" id="txtqualification" value="<?php echo $row['Qualification'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                   <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtGnd" type="text" id="txtGnd" value="<?php echo $row['Gender'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                   <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtBirthDate" type="text" id="txtBirthDate" value="<?php echo $row['BirthDate'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
                  <tr>
