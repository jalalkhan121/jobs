    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <option>Attock</option>
                      ...
                      </label><span class="textfieldRequiredMsg">Enter City</span></span></td>                    </tr>
                    <tr>
                      <td>Email:</td>
                    ...
                    <tr>
                      ...
                      <td><select name="cmbQue" id="cmbQue">
                        ...
                        <option selected="selected">Who is Your Favourite Personality?</option>
