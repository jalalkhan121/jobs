    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Post Job</strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertJob.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                        <td>Work Area:</td>
        <td><select  class="clickin-homeSelectbox"  name="job_category">
                        <option value="" selected="selected">--Select WorkArea--</option>
                        ...
                        <option>Fanance</option>
                        <option>Accounting</option>
                        <option>Banking</option>
                        <option>HR</option>
                        <option>Developer</option>
                         <option>Software</option>
                        <option>Hardware</option></select>
                          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
      ...
      <tr>
        ...
        <td><select name="Location" >
            ...
            <option>Rahim Yar Khan</option></select>
                          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                        </tr>
                        <tr>
                     ...
                     <tr>
                          <td>Apply LastDate:</td>
                      <td><span id="sprytextfield7">
                        <label>
                        <input type="text" name="applyDate" onclick="ds_sh(this);" id="txtBirthDate" />
                        </label>
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Posted New Job </strong></td>
                  </tr>
                  <tr>
