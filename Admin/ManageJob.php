                  ...
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        ...
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style12">Status</div></th>
                      ...
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Name;?></strong></div></td>
                         <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $City;?></strong></div></td>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $statu;?></strong></div></td>
                       
                         <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteJobseeker.php?JobSeekId=<?php echo $Id;?>">Delete</a></strong></div></td>
