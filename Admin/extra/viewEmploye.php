                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                        <tr>
                          <th height="34" bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Id</strong></div></th>
...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="#?EmpId=<?php echo $Id;?>">Edit</a></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DeleteEmp.php? EmpId=<?php echo $Id;?>">Delete</a></strong></div></td>
