                          ...
                          <table width="100%" border="0">
                            <tr style="display:none">
                              ...
                              <td><span id="sprytextfield1">
                                <label>
                                <input name="txtNewsId" type="text" id="txtUserId" value="<?php echo $newsId;?>" />
                                </label>
                            ...
                            <tr>
                              ...
                              <td><span id="sprytextfield2">
                                <label>
                                <input name="txtNews" type="text" id="txtUserName" value="<?php echo $news;?>" />
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
                              ...
                              <td><span id="sprytextfield3">
                                <label>
           <input name="txtDate" type="text" onclick="ds_sh(this);" id="txtDate"  value="<?php echo $newsDate;?>" />
                                </label>
                                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                            </tr>
                            <tr>
