    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <option>Lahore</option>
                      ...
                      </label><span class="textfieldRequiredMsg">Enter City</span></span></td>
                    </tr>
                    <tr>
                      <td>Email:</td>
                    ...
                    <tr>
                      ...
                      <td><label>
                        <select name="cmbQual" id="cmbQual">
                          ...
                          <option value="B.Sc(I.T)">B.Sc(IT)</option>
                    ...
                    <tr>
                      ...
                      <td><label>
                        ...
                        <input accept="doc/docx" type="file" name="txtFile" id="txtFile" />
                      </label></td>
                    </tr>
                    <tr>
                      <td>User Name:</td>
                    ...
                    <tr>
                      ...
                      <td><label>
                        <select name="cmbQue" id="cmbQue">
                          ...
                          <option>Who is Your Favourite Personality?</option>
